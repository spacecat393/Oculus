...
public class ElementRowEntry extends BaseEntry {
    ...
    @Override
    public void drawEntry(ShaderPackScreen screen, int index, int x, int y, int slotWidth, int slotHeight, int mouseX, int mouseY, boolean isMouseOver) {
        ...
        for (int i = 0; i < widgets.size(); i++) {
            ...
            widget.render(x + (int) ((singleWidgetWidth + 2) * i), y, (int) singleWidgetWidth, slotHeight + 2, mouseX, mouseY, 0, widgetHovered);
