...
public final class UnmodifiableListIterator<E> implements ListIterator<E>, Unmodifiable {
     ...
     * @return a new unmodifiable list iterator
     * @throws NullPointerException if the iterator is null
     * @deprecated method name has typo in it. Use {@link repack.apache.commons.collections4.iterators.UnmodifiableListIterator#unmodifiableListIterator(ListIterator)} instead.
     */
    @Deprecated
