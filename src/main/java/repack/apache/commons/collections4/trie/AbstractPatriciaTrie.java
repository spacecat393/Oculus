...
abstract class AbstractPatriciaTrie<K, V> extends AbstractBitwiseTrie<K, V> {
    ...
    /** The root node of the {@link repack.apache.commons.collections4.Trie}. */
    ...
    /** The current size of the {@link repack.apache.commons.collections4.Trie}. */
    private transient int size;

    /**
     * The number of times this {@link repack.apache.commons.collections4.Trie} has been modified.
    ...
    /**
     * Constructs a new {@link repack.apache.commons.collections4.Trie}
     * using the given {@link KeyAnalyzer} and initializes the {@link repack.apache.commons.collections4.Trie}
    ...
    /**
     * A helper method to increment the {@link repack.apache.commons.collections4.Trie} size and the modification counter.
     */
    void incrementSize() {
        size++;
        incrementModCount();
    ...
    /**
     * A helper method to decrement the {@link repack.apache.commons.collections4.Trie} size and increment the modification counter.
     */
    void decrementSize() {
        size--;
        incrementModCount();
    ...
    /**
     * Adds the given {@link TrieEntry} to the {@link repack.apache.commons.collections4.Trie}.
     */
     ...
     * </ol>
     *
     * If the {@link repack.apache.commons.collections4.Trie} contained 'H' and 'L', a lookup of 'D' would
    ...
    /**
     * Removes a single entry from the {@link repack.apache.commons.collections4.Trie}.
     *
    ...
    /**
     * Removes an external entry from the {@link repack.apache.commons.collections4.Trie}.
     *
    ...
    /**
     * Removes an internal entry from the {@link repack.apache.commons.collections4.Trie}.
     *
    ...
    /**
     * Returns the first entry the {@link repack.apache.commons.collections4.Trie} is storing.
     * <p>
    ...
    /**
     * Returns a view of this {@link repack.apache.commons.collections4.Trie} of all elements that are prefixed
     ...
     * This information is cached until the PATRICIA {@link repack.apache.commons.collections4.Trie} changes.
     ...
     * @return a {@link SortedMap} view of this {@link repack.apache.commons.collections4.Trie} with all elements whose
    ...
    /**
     * Returns the last entry the {@link repack.apache.commons.collections4.Trie} is storing.
     *
    ...
    /**
     *  A {@link repack.apache.commons.collections4.Trie} is a set of {@link TrieEntry} nodes.
     */
    ...
    /**
     * This is an entry set view of the {@link repack.apache.commons.collections4.Trie} as returned by {@link Map#entrySet()}.
     */
    ...
    /**
     * This is a key set view of the {@link repack.apache.commons.collections4.Trie} as returned by {@link Map#keySet()}.
     */
    ...
    /**
     * This is a value view of the {@link repack.apache.commons.collections4.Trie} as returned by {@link Map#values()}.
     */
    ...
    /**
     * An {@link OrderedMapIterator} for a {@link repack.apache.commons.collections4.Trie}.
     */
    ...
    /**
     * A range view of the {@link repack.apache.commons.collections4.Trie}.
     */
    ...
    /**
     * A submap used for prefix views over the {@link repack.apache.commons.collections4.Trie}.
     */
    private class PrefixRangeMap extends RangeMap {
         ...
         * time the {@link repack.apache.commons.collections4.Trie} has changed.
         */
        private int fixup() {
    ...
    /**
     * A prefix {@link RangeEntrySet} view of the {@link repack.apache.commons.collections4.Trie}.
     */
