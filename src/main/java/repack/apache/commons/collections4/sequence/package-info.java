 ...
 * {@link repack.apache.commons.collections4.sequence.EditScript edit script} containing
 * all the {@link repack.apache.commons.collections4.sequence.EditCommand commands}
 * needed to transform the first sequence into the second one.
 * The entry point for the user to this algorithm is the
 * {@link repack.apache.commons.collections4.sequence.SequencesComparator} class.
 * <p>
 ...
 * the {@link repack.apache.commons.collections4.sequence.CommandVisitor} interface.
 * <p>
 ...
 * simple {@link repack.apache.commons.collections4.sequence.ReplacementsHandler} interface,
 * using an instance of the {@link repack.apache.commons.collections4.sequence.ReplacementsFinder}
 ...
 * {@link repack.apache.commons.collections4.sequence.ReplacementsHandler#handleReplacement handleReplacement}
 * method is also provided. This allows the user to keep track of the current index in
 * both arrays if he needs so.
 *
 */
package repack.apache.commons.collections4.sequence;
